...
import cn.edu.ruc.iir.paraflow.commons.exceptions.ColumnRenameException;
...
public class RenameColumnAction extends Action
{
    @Override
    public ActionResponse act(ActionResponse input, Connection connection) throws ParaFlowException
    {
        ...
        if (dbIdOp.isPresent()
            ...
            String sqlStatement = SQLTemplate.renameColumn(
                    dbId,
                    tblId,
                    oldName,
                    newName);
            ...
            if (status == 0) {
                throw new ColumnRenameException();
            }
        }
        else {
