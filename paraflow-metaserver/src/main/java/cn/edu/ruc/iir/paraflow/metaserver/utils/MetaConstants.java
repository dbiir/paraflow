...
public final class MetaConstants
{
    ...
    public static String createTblModelSql = "CREATE TABLE meta_tblmodel (tblid SERIAL primary key, dbid int REFERENCES meta_dbmodel(dbid), tblname varchar(50), userid int REFERENCES meta_usermodel(userid), createtime bigint, lastaccesstime bigint, locationUrl varchar(100), storageformat varchar(20), fiberColId int, timeColId int, fiberfunc varchar(500), constraint unique_tbl unique(dbid,tblname));";
