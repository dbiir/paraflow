...
public class CreateStorageFormatAction extends Action
{
    @Override
    public ActionResponse act(ActionResponse input, Connection connection) throws ParaFlowException
    {
        ...
        if (paramOp.isPresent()) {
            MetaProto.StorageFormatParam storageFormatParam
                    = (MetaProto.StorageFormatParam) paramOp.get();
            String userStatement = SQLTemplate.createStorageFormat(
                    storageFormatParam.getStorageFormatName(),
                    storageFormatParam.getCompression(),
                    storageFormatParam.getSerialFormat());
