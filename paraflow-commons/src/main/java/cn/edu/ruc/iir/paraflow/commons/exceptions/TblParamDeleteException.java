 ...
 */
public class TblParamDeleteException extends ParaFlowException
{
    private static final long serialVersionUID = 3329545815757961350L;
    ...
    {
        return "table param delete exception";
    }
