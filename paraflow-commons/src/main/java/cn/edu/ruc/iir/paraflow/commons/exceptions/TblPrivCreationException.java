...
public class TblPrivCreationException extends ParaFlowException
{
    private static final long serialVersionUID = -820133160608956886L;
    ...
    {
        return "table privilege creation exception";
    }
